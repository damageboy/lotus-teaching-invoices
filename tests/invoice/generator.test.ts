...
const classes: ParsedClass[] = [
  { studioName: "Zen Yoga", classType: "Vinyasa Flow", date: "2026-01-03", startTime: "09:00", endTime: "10:15", studentCount: 8 },
  { studioName: "Zen Yoga", classType: "Yin Yoga", date: "2026-01-05", startTime: "18:00", endTime: "19:15", studentCount: 3 },
  { studioName: "Zen Yoga", classType: "Vinyasa Flow", date: "2026-01-10", startTime: "09:00", endTime: "10:15", studentCount: 12 },
];
...
describe("generateInvoice", () => {
  ...
  it("skips classes with 0 students and warns", () => {
    const classesWithZero: ParsedClass[] = [
      { studioName: "Zen Yoga", classType: "Vinyasa", date: "2026-01-03", startTime: "09:00", endTime: "10:15", studentCount: 8 },
      { studioName: "Zen Yoga", classType: "Hatha", date: "2026-01-05", startTime: "09:00", endTime: "10:15", studentCount: 0 },
    ];

    const { invoice, warnings } = generateInvoice(
      "Zen Yoga",
      classesWithZero,
      studioConfig,
      { from: "2026-01-01", to: "2026-01-31" },
