...
export function EventDetailsCard({
  ...
  const left = Math.max(12, Math.min(rect.right + 8, window.innerWidth - 308));
  ...
  }, [onClose, pendingSeriesStudio, pendingValueEdit, seriesPreflight, valueDialog]);
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          ...
          onClick={onClose}
          className="rounded px-2 py-1 text-xs font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
          Close
        </button>
      </div>
      ...
      <div className="relative mt-4">
        <button
          ...
          className="w-full rounded-md border border-gray-300 px-3 py-2 text-left text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:cursor-not-allowed disabled:opacity-45"
        >
            ...
            {studioNames.length === 0 ? (
              ...
              studioNames.map((studioName) => (
                <button
                  ...
                  className="block w-full px-3 py-2 text-left text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 focus:bg-indigo-50 focus:outline-none"
                >
                  {studioName}
                </button>
              ))
      ...
      <div className="mt-2 grid grid-cols-2 gap-2">
        <button
          ...
          className="rounded-md border border-gray-300 px-3 py-2 text-left text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:cursor-not-allowed disabled:opacity-45"
        >
          Set Students
        </button>
        <button
      ...
      {!canEdit && <p className="mt-3 text-xs text-gray-500">Calendar editing is not available.</p>}
      {error && (
        ...
        >
          ...
          <dl className="mt-3 space-y-2 text-xs">
            ...
            <div>
              ...
              <dd className="break-words text-gray-800">{pendingValueEdit.proposedDescription}</dd>
            </div>
          </dl>
